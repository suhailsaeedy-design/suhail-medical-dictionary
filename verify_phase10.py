...
if str(ca.get('ownerEmail','')).lower()!='suhailsaeedy@gmail.com':errors.append('verified owner email mismatch')
if ca.get('requireSameAccount') is not True:errors.append('same-account owner verification must be enabled')
