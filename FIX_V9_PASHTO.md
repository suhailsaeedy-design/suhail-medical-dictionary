...
## مهم بدلونونه
- Default Theme: **Light**
- په موبایل کې Hamburger button او Slide-out Sidebar
- Dictionary, AI Study, Selected, Offline Packs, Bookmarks, History, About او Settings په موبایل کې ټول لاسرسی لري
- Mobile term cards کوچني او چټک scan کېدونکي شول
- د لغت 3D visual په کارت کې تاوېږي؛ انتخاب شوی لغت په Detail panel کې هم 360° تاوېږي او Drag هم کېدلی شي
- Mouse pointer پسې د اوبو/روښنايي کوچني droplets effect
...
## GitHub ته پورته کول
1. د repository فولډر دننه ټول زاړه فایلونه حذف کړئ، خو `.git` مه حذف کوئ.
2. د دې ZIP دننه ټول فایلونه مستقیم repository root ته Copy/Paste کړئ.
3. GitHub Desktop: `Commit to main` او بیا `Push origin`.
4. Actions کې تر شین ✅ پورې انتظار وکړئ.
