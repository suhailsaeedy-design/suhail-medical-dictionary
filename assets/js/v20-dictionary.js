...
function ensureMobileMenuButton(){
  const top=$('.med-topbar');if(!top||$('.v20-mobile-menu-button',top))return;
  const btn=document.createElement('button');btn.type='button';btn.className='v20-mobile-menu-button';btn.setAttribute('aria-label','Open navigation');btn.innerHTML='<i class="bi bi-list"></i>';
