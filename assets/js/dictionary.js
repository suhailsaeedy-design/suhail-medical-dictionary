(() => {
  ...
  function renderTerms(){
    const grid=$('#termGrid');grid.dataset.cols=String(state.view);$$('.view-btn').forEach(b=>b.classList.toggle('active',Number(b.dataset.cols)===state.view));$('#resultTitle').textContent=resultLabel();$('#selectedActions').classList.toggle('hidden',state.mode!=='selected');
