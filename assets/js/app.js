import './core.js?v=8.0.0';
import {getSupabase,currentSession,signOut,logEvent,getMyProfile,setOwnerReviewConsent} from './auth.js?v=8.0.0';
...
const aiModule=()=>aiModulePromise||(aiModulePromise=import('./ai.js?v=8.0.0'));
const exportModule=()=>exportModulePromise||(exportModulePromise=import('./export.js?v=8.0.0'));
const pwaModule=()=>pwaModulePromise||(pwaModulePromise=import('./pwa.js?v=8.0.0'));
