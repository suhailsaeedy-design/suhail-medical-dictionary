import {currentSession,peekSession,signOut,getMyProfile,setOwnerReviewConsent,logEvent,hasPrivacyConsent,rememberPrivacyConsent} from './auth.js?v=20.18.1';
import {createChat,listChats,loadMessages,renameChat,deleteChat,editUserMessage,askAI,getAIServiceStatus} from './ai.js?v=20.18.1';
...
async function init(){
  ...
  await Promise.allSettled([loadProfile(),refreshChats(),checkBackend(),logEvent('ai_page_open',{build:'20.18.1'})]);
