...
if not (('Final Release' in first) or ('Post-Release' in first) or ('Live Cloud Sync' in first) or ('Pre-Production' in first) or ('Owner Bootstrap' in first) or (m and int(m.group(1))>=15)):errors.append('workflow name older than Phase 15/current release')
