...
- Service worker source validation: PASS
- GitHub Pages release build (local source build): PASS
- Default theme: Light (`clinical`)
- Mobile slide-out navigation: implemented
- Compact mobile term cards: implemented
- Mobile detail bottom sheet: implemented
