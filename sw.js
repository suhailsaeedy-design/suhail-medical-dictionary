const BUILD_VERSION='20260920-v20181';
const VERSION=`smd-${/^__BUILD_/.test(BUILD_VERSION)?'20.18.1-source':BUILD_VERSION}`;
...
const CORE=[
  ...
  './assets/css/v20-dictionary-foundation.css','./assets/css/v20-17-repair.css','./assets/css/v20-18-polish.css','./assets/css/v20-admin-login.css','./assets/js/config.js','./assets/js/auth.js',
  ...
  './assets/js/v20-anatomy.js','./assets/js/v20-offline.js','./assets/js/v20-17-repair.js','./assets/js/v20-18-polish.js','./assets/js/v20-access-guard.js','./assets/js/v20-legal-consent.js','./assets/js/admin-login.js','./','./index.html','./app.html','./admin-login.html',
