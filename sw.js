...
const CORE=[
  ...
  './manifest.webmanifest','./version.json','./ai-config.json','./assets/css/styles.css','./assets/css/v16-foundation.css','./assets/css/v16-reference-base.css','./assets/css/v16-reference-match.css','./assets/css/v16-phase2-mobile.css','./assets/css/v16-phase3-detail.css','./assets/css/v16-phase4-ai-settings.css','./assets/css/v16-final-audit.css','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/images/suhail-saeedy.webp',
  './assets/js/config.js','./assets/js/v16-ui.js','./assets/js/auth.js','./assets/js/ai.js','./assets/js/ai-page.js','./assets/js/export.js','./assets/js/pwa.js','./assets/vendor/jszip.min.js',
