const BUILD_VERSION='20260920-v20192';
const VERSION=`smd-${/^__BUILD_/.test(BUILD_VERSION)?'20.19.2-source':BUILD_VERSION}`;
...
const CORE=[
  ...
  './assets/css/v20-dictionary-foundation.css','./assets/css/v20-17-repair.css','./assets/css/v20-18-polish.css','./assets/css/v20-18-2-final-layout.css','./assets/css/v20-19-aqua-glass.css','./assets/css/v20-19-1-unified-shell.css','./assets/css/v20-19-2-responsive-qa.css','./assets/css/v20-admin-login.css','./assets/js/config.js','./assets/js/auth.js',
  ...
  './assets/js/v20-anatomy.js','./assets/js/v20-offline.js','./assets/js/v20-17-repair.js','./assets/js/v20-18-polish.js','./assets/js/v20-18-2-final-layout.js','./assets/js/v20-19-1-unified-shell.js','./assets/js/v20-19-2-responsive-qa.js','./assets/js/v20-access-guard.js','./assets/js/v20-legal-consent.js','./assets/js/admin-login.js','./','./index.html','./app.html','./admin-login.html',
...
self.addEventListener('fetch',event=>{
  ...
  if(url.origin===location.origin){
    ...
    if(url.pathname.endsWith('/version.json')||url.pathname.endsWith('/ai-config.json')){event.respondWith((async()=>{try{return await fetch(event.request,{cache:'no-store'});}catch{return (await caches.match(event.request))||new Response(JSON.stringify({offline:true}),{status:503,headers:{'content-type':'application/json'}});}})());return;}
