...
self.addEventListener('fetch',event=>{
  ...
  const securityPath=/\/(admin(?:-login)?\.html|auth-callback\.html|assets\/js\/(?:admin-|cloud-auth\.js)|data\/(?:admin-|auth-config\.json))/;
  if(securityPath.test(url.pathname)){
