...
const CORE=[
  ...
  './assets/css/v17-mobile.css','./assets/css/v17-login.css','./assets/css/v17-phase4-detail-ai.css','./assets/css/v17-final-integration.css','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/images/suhail-saeedy.webp',
  './assets/js/config.js','./assets/js/v16-ui.js','./assets/js/v17-desktop.js',
  './assets/js/v17-mobile.js','./assets/js/v17-login.js','./assets/js/v17-phase4-detail.js','./assets/js/v17-phase4-ai-mobile.js','./assets/js/v17-final-integration.js','./assets/js/auth.js','./assets/js/ai.js','./assets/js/ai-page.js','./assets/js/export.js','./assets/js/pwa.js','./assets/vendor/jszip.min.js',
