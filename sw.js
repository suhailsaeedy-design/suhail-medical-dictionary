...
const CORE=[
  ...
  './manifest.webmanifest','./version.json','./ai-config.json','./assets/css/styles.css','./assets/css/v7.css','./assets/css/v8.css','./assets/css/v9-reference.css','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/images/suhail-saeedy.webp',
