...
const VERSION=`smd-${/^__BUILD_/.test(BUILD_VERSION)?'19.0.0-source':BUILD_VERSION}`;
...
const CORE=[
  ...
  './assets/css/v19-core.css','./assets/css/v19-phase4-offline-admin.css','./assets/css/v19-login.css','./assets/css/v19-anatomy.css','./assets/css/v19-mobile.css','./assets/css/v19-phase3.css',
  './assets/js/v19-core.js','./assets/js/v19-phase4-offline-admin.js','./assets/js/v19-login.js','./assets/js/v19-anatomy-webgl.js','./assets/js/v19-mobile.js','./assets/js/v19-phase3.js',
  './','./index.html','./app.html','./anatomy.html','./ai.html','./admin.html','./about.html','./privacy.html','./terms.html','./offline.html',
  ...
  './data/index.json','./data/packs.json','./data/offline/manifest.json','./data/anatomy/manifest.json','./assets/models/anatomy/low/skeleton.obj','./assets/models/anatomy/low/muscles.obj','./assets/models/anatomy/low/organs.obj','./assets/models/anatomy/low/systems.obj',
