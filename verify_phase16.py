...
if not ('Phase 16' in wf.splitlines()[0] or 'Final Release' in wf.splitlines()[0] or 'Post-Release' in wf.splitlines()[0] or 'Live Cloud Sync' in wf.splitlines()[0] or 'Pre-Production' in wf.splitlines()[0] or 'Owner Bootstrap' in wf.splitlines()[0]):errors.append('workflow name must identify Phase 16-or-later/current deployment')
